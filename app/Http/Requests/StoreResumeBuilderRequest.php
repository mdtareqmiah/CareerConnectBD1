...
class StoreResumeBuilderRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'personal_information.theme' => ['nullable', 'string', 'max:100'],
            'personal_information.spacing' => ['nullable', 'string', 'in:compact,normal,spacious'],
            'personal_information.visibility_options' => ['nullable', 'array'],
            'personal_information.visibility_options.*' => ['nullable', 'boolean'],
