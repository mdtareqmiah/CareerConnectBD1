...
<div class="container py-4 py-lg-5">
    <div class="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center mb-4 gap-3">
        ...
        <div class="d-flex gap-2">
            <a href="{{ route('employer.jobs.trash') }}" class="btn btn-outline-secondary">View Trash</a>
    ...
    <div class="row g-4 mb-4">
        ...
        <div class="col-lg-3 col-sm-6">
            <div class="card border-0 shadow-sm p-3 text-center">
                ...
                <div class="h4 mb-0">{{ ($stats['closed_jobs'] ?? 0) + ($stats['expired_jobs'] ?? 0) }}</div>
            </div>
        </div>
    </div>
                        ...
                        <div class="row align-items-center">
                            <div class="col-md-8">
                                ...
                                <p class="text-muted mb-1">
                                    {{ $job->location }}@if($job->job_type) · {{ $job->job_type }}@endif · {{ ucfirst($job->display_status) }}
                                </p>
                                @if($job->deadline)
                                    <p class="mb-1">Deadline: {{ $job->deadline->format('F j, Y') }}</p>
                                @endif
                            ...
                            <div class="col-md-4 text-md-end mt-3 mt-md-0">
                                ...
                                <a href="{{ route('employer.jobs.edit', $job) }}" class="btn btn-sm btn-outline-secondary">Edit</a>
