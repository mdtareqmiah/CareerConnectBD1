                ...
                <div class="card-body p-4 p-lg-5">
                    <div class="border rounded-4 bg-light p-3 p-md-4 mb-4">
                        <div class="d-flex align-items-start gap-2">
                            ...
                            <div>
                                <p class="fw-semibold mb-1">Keep the posting accurate and compelling.</p>
                                <p class="text-muted small mb-0">Update the role as responsibilities, compensation, or hiring needs evolve.</p>
                            </div>
                        </div>
                    </div>
