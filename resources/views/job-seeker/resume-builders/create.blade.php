...
<script>
    ...
    const initialSections = {
        ...
        professional_summary: @json(old('professional_summary') ?? ''),
        education: profileEducations.length ? profileEducations : [],
        experience: profileExperiences.length ? profileExperiences : [],
        skills: profileSkills.length ? profileSkills : [],
        projects: [],
        certifications: [],
        languages: [],
        references: [],
    ...
    const saveDraft = async () => {
        ...
        if (payload.id) {
            timedSave.builderId = payload.id;
    ...
    window.resumeBuilder = {
        ...
        removeEducation(index) { moveItem(state.education, index, 0); state.education.splice(index, 1); renderEducationItems(); normalizeState(); },
