...
<form action="{{ $action }}" method="POST" class="row g-3">
    ...
    <div class="col-12">
        ...
        <textarea class="form-control @error('job_description') is-invalid @enderror" id="job_description" name="job_description" rows="4">{{ old('job_description', $experience?->job_description) }}</textarea>
    ...
    <div class="col-12 d-flex justify-content-between align-items-center">
        <a href="{{ route('job-seeker.experiences.index') }}" class="btn btn-outline-secondary">Cancel</a>
