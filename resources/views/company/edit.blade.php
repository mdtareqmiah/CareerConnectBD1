...
<div class="container py-4">
    <div class="row">
        <div class="col-md-12">
            ...
            <!-- Header -->
            <div class="mb-4">
                <h1 class="h2 mb-2">Edit Company Profile</h1>
                    ...
                    <form action="{{ route('company.update', $company) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-4">
                            ...
                            @if ($company->company_logo && \Illuminate\Support\Facades\Storage::disk('public')->exists("company-logos/{$company->company_logo}"))
                                <div class="mb-3">
                                    <img src="{{ $company->company_logo_url }}" alt="{{ $company->company_name }}" style="max-width: 150px; max-height: 150px;" class="img-thumbnail">
                                </div>
                            @endif
