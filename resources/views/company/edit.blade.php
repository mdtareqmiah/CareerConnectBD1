        ...
        <div class="col-12">
            <nav aria-label="breadcrumb" class="mb-4">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="{{ route('company.show', $company) }}">{{ $company->company_name }}</a></li>
            ...
            <div class="d-flex flex-column flex-lg-row justify-content-between align-items-lg-center gap-3 mb-4">
                <div>
                    <div class="d-inline-flex align-items-center gap-2 rounded-pill bg-primary-subtle text-primary px-3 py-2 mb-3">
                        ...
                        <span class="fw-semibold">Profile update</span>
                    </div>
                    <h1 class="h3 mb-2">Edit company profile</h1>
                    <p class="text-muted mb-0">Update your company information.</p>
                </div>
            </div>
                ...
                <div class="card-body p-4 p-lg-5">
                    <div class="border rounded-4 bg-light p-3 p-md-4 mb-4">
                        <div class="d-flex align-items-start gap-2">
                            ...
                            <div>
                                <p class="fw-semibold mb-1">Keep your public profile current.</p>
                                <p class="text-muted small mb-0">Update your company details whenever your team, location, or hiring priorities change.</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <form action="{{ route('company.update', $company) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-4">
                            ...
                            @if ($company->company_logo && \Illuminate\Support\Facades\Storage::disk('public')->exists("company-logos/{$company->company_logo}"))
                                <div class="mb-3">
                                    <img src="{{ $company->company_logo_url }}" alt="{{ $company->company_name }}" style="max-width: 150px; max-height: 150px;" class="img-thumbnail rounded-4">
                                </div>
                            @endif
                        ...
                        <div class="row g-3 mt-1">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="number" class="form-control @error('founded_year') is-invalid @enderror" id="founded_year" name="founded_year" value="{{ old('founded_year', $company->founded_year) }}" min="1800" max="{{ date('Y') }}" required>
                                @error('founded_year')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="row g-3 mt-1">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control @error('country') is-invalid @enderror" id="country" name="country" value="{{ old('country', $company->country) }}" required>
                                @error('country')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="mt-4">
                            ...
                            <textarea class="form-control @error('company_description') is-invalid @enderror" id="company_description" name="company_description" rows="4">{{ old('company_description', $company->company_description) }}</textarea>
                        ...
                        <div class="d-flex flex-wrap gap-2 mt-4">
                            ...
                            <a href="{{ route('company.show', $company) }}" class="btn btn-outline-secondary">Cancel</a>
                        </div>
                    </form>
                </div>
            </div>
